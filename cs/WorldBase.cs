...
public abstract class WorldBase : IBlockAccess
{
  ...
  public abstract void SetBlockRPC(
    int _clrIdx,
    Vector3i _blockPos,
  ...
  public abstract bool CanPlaceLandProtectionBlockAt(
    Vector3i blockPos,
    PersistentPlayerData lpRelative);

  public abstract bool CanPlaceBlockAt(
    Vector3i blockPos,
    PersistentPlayerData lpRelative,
  ...
  public abstract float GetLandProtectionHardnessModifier(
    Vector3i blockPos,
    EntityAlive lpRelative,
    PersistentPlayerData ppData);

  public abstract bool IsMyLandProtectedBlock(
    Vector3i worldBlockPos,
    PersistentPlayerData lpRelative,
    bool traderAllowed = false);

  public abstract EnumLandClaimOwner GetLandClaimOwner(
    Vector3i worldBlockPos,
    PersistentPlayerData lpRelative);
